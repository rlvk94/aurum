...
export const defaultCategories: DefaultCategorySeed = [
  {
    ...
    children: [
      ...
      {
        name: {
          da: "Indbo- & familieforsikring",
          en: "Contents & family insurance",
        },
        icon: "🛋️",
  ...
  },
  {
    ...
    children: [
      ...
      {
        name: {
          da: "Bilforsikring & autohjælp",
          en: "Car insurance & roadside assistance",
        },
        icon: "🛡️",
        keywords: [
          "bilforsikring",
  ...
  },
  {
    ...
    children: [
      ...
      {
        name: {
          da: "Kiosk, bager & specialbutikker",
          en: "Kiosk, bakery & specialty stores",
        },
        icon: "🥐",
        keywords: [
          "kiosk",
  ...
  },
  {
    ...
    children: [
      ...
      {
        name: {
          da: "Elektronik & computerudstyr",
          en: "Electronics & computer equipment",
        },
        icon: "💻",
        keywords: [
          "elgiganten",
      ...
      {
        name: {
          da: "Online services & software",
          en: "Online services & software",
        },
        icon: "🖥️",
        keywords: [
          "dropbox",
      ...
      {
        name: {
          da: "Biograf, koncerter & forlystelser",
          en: "Cinema, concerts & attractions",
        },
        icon: "🎬",
        keywords: [
          "biograf",
      ...
      {
        name: {
          da: "Højskole- & kursusophold",
          en: "Folk high school & courses",
        },
        icon: "🏫",
